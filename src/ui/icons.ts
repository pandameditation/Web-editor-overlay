...
const PATHS: Record<string, string> = {
  ...
  alert: 'M8 2.4l5.9 10.4H2.1zM8 6.3v3.1M8 11.4h.01',

  // Actions
  play: 'M5.4 3.6l7.2 4.4-7.2 4.4z',
  ...
  folder: 'M2.6 12.8V3.6h3.9l1.4 1.9h5.5v7.3z',
  server: 'M2.6 3.4h10.8v3.6H2.6zM2.6 9h10.8v3.6H2.6zM5 5.2h.01M5 10.8h.01',
  file: 'M4 2.6h5l3 3v7.8H4zM9 2.6v3h3',
